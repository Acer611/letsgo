...
public class FileDownloadUtil {
    ...
    public static File  downloadNet(String headUrl,String targetPath) throws MalformedURLException {
        // 下载网络文件
        int bytesum = 0;
        int byteread = 0;
        File file = null;
       ...
       /* String filename = "images.jpg";
        String filePath = targetPath + System.getProperty("file.separator") + filename;*/
