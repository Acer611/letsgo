...
*/
        ...
        data.put("sig", util.strToHash(String.format(
				...
				txAppkey, random, curTime, phoneNumber)));
        data.put("tel", tel);
        ...
        // 与上面的 random 必须一致
		String wholeUrl = String.format("%s?sdkappid=%d&random=%d", url, txAppid, random);
...
*/
        ...
        data.put("tel", tel);
        data.put("sig", util.calculateSigForTempl(txAppkey, random, curTime, phoneNumber));
