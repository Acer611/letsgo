...
public class tls_sigature {
	...
	/*
	public static GenTLSSignatureResult sigature(String identifier){
		try{			
			//Use pemfile keys to test
		    String privStr = "-----BEGIN PRIVATE KEY-----\n" +
			"MIGEAgEAMBAGByqGSM49AgEGBSuBBAAKBG0wawIBAQQg7QM1TGm5K6O0BkvujHsN\n" +
			"HPy+i9ekNB6+BC2S70SI2QihRANCAASi0EKHGrIM4xecCPq3CqxCLglaSk+DRgvP\n" +
			"ubsfgpjlBZelgrQihT1oSzOr6vKTSES8oPcPgnt6YzXF8vkrR4FA\n" +
			"-----END PRIVATE KEY-----";

            // generate signature
            GenTLSSignatureResult result = GenTLSSignatureEx(1400008293, identifier, privStr);
	...
	public static void checkSigature(String identifier, GenTLSSignatureResult result){
		try{				    
			//change public pem string to public string
			String pubStr = "-----BEGIN PUBLIC KEY-----\n"+
			"MFYwEAYHKoZIzj0CAQYFK4EEAAoDQgAEotBChxqyDOMXnAj6twqsQi4JWkpPg0YL\n"+
			"z7m7H4KY5QWXpYK0IoU9aEszq+ryk0hEvKD3D4J7emM1xfL5K0eBQA==\n"+
			"-----END PUBLIC KEY-----";

            // check signature
            CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, 1400008293, identifier, pubStr);
