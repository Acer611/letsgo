...
public class CoreServiceImpl implements ICoreService {
    ...
    @Autowired
    protected LocationHandler localtionHandler;
    ...
    public void refreshRouter() {
        ...
        // 关注事件
        newRouter.rule().msgType(WxConsts.XML_MSG_EVENT)
       ...
       /* newRouter.rule().async(false).msgType(WxConsts.XML_MSG_EVENT)
                .event(WxConsts.EVT_VIEW).handler(this.viewHandler)
                .end();*/

        //扫码事件
        newRouter.rule().msgType(WxConsts.XML_MSG_EVENT)
                .event(WxConsts.EVT_SCAN).handler(this.scanHandler)
                .end();

        // 上报地理位置事件
        newRouter.rule().msgType(WxConsts.XML_MSG_EVENT)
                .event(WxConsts.EVT_LOCATION).handler(this.localtionHandler)
                .end();
